# referee_3 Round 00 Packet

- Run id: `oasis_demo`
- Packet type: prompt input
- Created at UTC: `2026-07-05T20:32:51.669099+00:00`
...
- prior `referee_3` reviews and Researcher responses when `round_id` is not `00`
- current Integrity Checker report when available

## Allowed Outputs

- `agents/referee_3/workspace/oasis_demo/review_round_00.md`
...
Use issue IDs beginning with `R3-`. Every major or blocking

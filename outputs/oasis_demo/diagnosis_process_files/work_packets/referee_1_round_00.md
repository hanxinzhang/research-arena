# referee_1 Round 00 Packet

- Run id: `oasis_demo`
- Packet type: prompt input
- Created at UTC: `2026-07-05T20:32:51.669028+00:00`
...
- prior `referee_1` reviews and Researcher responses when `round_id` is not `00`
- current Integrity Checker report when available

## Allowed Outputs

- `agents/referee_1/workspace/oasis_demo/review_round_00.md`
...
Use issue IDs beginning with `R1-`. Every major or blocking

# Human-Readable Revision Output

Run id: `oasis_demo`

Submission: `submission_001_researcher_1`

Revision: `revision_01`

Source revision folder: `submissions/oasis_demo/submission_001_researcher_1/revision_01`

## Contents

- `manuscript.pdf`: text-only manuscript PDF for reading and review.
- `article.pdf`: optional integrated journal-style article PDF when the revision
  includes `article/article.pdf`.
